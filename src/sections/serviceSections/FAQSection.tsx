...
//         <Image src="/faqs.png" alt="FAQ Illustration" width={250} height={250} />
//       </div>
...
const FAQSection = () => {
  return (
    ...
    <div className="flex flex-col md:flex-row items-center gap-8 p-8 h-screen overflow-hidden">
      {/* Illustration */}
      <div className="w-full flex justify-center">
        <Image src="/faqs.png" alt="FAQ Illustration" width={400} height={400} />
      </div>
      
      {/* FAQ Content */}
      <div className="w-full md:w-1/2 space-y-6 overflow-y-auto max-h-full p-4">
        <h2 className="text-lg font-bold text-gray-700">FAQ’s</h2>
