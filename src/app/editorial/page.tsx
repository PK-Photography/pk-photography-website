...
// Editorial images
import editorial1 from "@/../public/editorial/1.jpeg";
import editorial2 from "@/../public/editorial/2.jpeg";
    ...
    <div className="pl-6 pr-6 ">
      <div className="flex sm:flex-col md:flex-row justify-between pb-9 border-b-2 border-[#747478]">
        ...
        <div className="flex flex-col text-right gap-4 sm:mt-[10%] md:mt-0">
          <a href="/galleries?category=Editorial">
      ...
      <div className="pt-6 flex flex-col md:flex-row mb-[10%]">
        <div className="flex flex-col justify-start items-start border-r-2 border-[#747478] pr-12">
          <p className="pt-8">
            Professional editorial photography for magazines and publications.
          </p>
          <p className="pt-1">
            Capture compelling stories with images that convey narrative and{" "}
          </p>
          <p className="pt-1">
            emotion. Your journey to exceptional editorial photography starts here.
          </p>

          <a href="/booking?service=editorial">
      ...
      <GetStartedSection
        text1="Tell Compelling Stories"
        text2=" with Professional"
        text3="Editorial Photography"
      />
      ...
      <div className="flex flex-col items-center justify-center mt-10">
        ...
        <p className="text-[15px] text-[#5C5C5C] mt-4 max-w-3xl text-center">
          ...
          efforts to capture your editorial vision. It&apos;s
          more than just a transaction - it&apos;s delivering images that tell powerful stories.
        </p>
      </div>
