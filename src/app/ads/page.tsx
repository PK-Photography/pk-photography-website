    ...
    <div className="pl-6 pr-6 ">
      ...
      <div className="pt-6 flex flex-col md:flex-row mb-[10%]">
        <div className="flex flex-col justify-start items-start border-r-2 border-[#747478] pr-12">
          <p className="pt-8">
            Professional advertising photography that makes your products stand out.
          </p>
          <p className="pt-1">
            Create compelling visual content that drives engagement and{" "}
          </p>
          <p className="pt-1">
            conversions. Your journey to exceptional ad photography starts here.
          </p>

          <a href="/booking?service=ads">
      ...
      <GetStartedSection
        text1="Drive Engagement"
        text2=" with Professional"
        text3="Ad Photography"
      />
      ...
      <div className="flex flex-col items-center justify-center mt-10">
        ...
        <p className="text-[15px] text-[#5C5C5C] mt-4 max-w-3xl text-center">
          ...
          efforts to create compelling ad visuals. It&apos;s
          more than just a transaction - it&apos;s delivering images that drive results.
        </p>
      </div>
